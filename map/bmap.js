(function() {
    ...
    l.extend(m, {
        ...
        correct_pts: {},
        _hostUrl: "qt.php?qt=getreferencepoint&",
    ...
    l.extend(ao, {
        ...
        preLoaded: {},
        Config: {
            _baseUrl: "get.php?qt=getmodules&v=1.1",
            _timeout: 5000
        },
        delayFlag: false,
        Module: {
...
baidu.localStorage = function(a) {
    ...
    this.flashURL = a.flashURL || MapConfig.smFlwCon + "image/LocalStorage.swf?v=20101012";
...
var modelConfig = {
    MODEL_URL: MapConfig.smFlwCon + "component_c/",
    DATA_URL: "s.php?newmap=1&qt=",
                ...
                if (json.result.type == 39 && place.result == true) {
                    ...
                    if (poiSSG) {
                        ...
                        if (document.getElementById("poiTS")) {
                            T.g("poiTS").href = "http://tousu.baidu.com/map/add?place=" + encodeURIComponent(json.result.wd)
                        }
                    }
                    switchTab(1)
                }
        ...
        if (this.mainDiv) {
            ...
            if (m.history != true) {
                if (T.browser.ie > 0 || T.browser.chrome > 0 || T.browser.safari > 0) {
                    T.g("wHistory").src = MapConfig.smFlwCon + "history.html?url=" + escape(f)
                } else {
                    j.submit()
                }
                this.opts._mapInfo = {
...
function getPoiPoint(a) {
    ...
    d = null,
    c = "sate-tip-div",
    b = "<div class='satetip' id='" + c + "' style='display:none'><div class='text'>猛击吧，百度的卫星图！</div><div class='satetip-tip'></div><a onclick='hideSateCtrlTip();return false;' class='close' href='javascript:void(0)'>关闭</a></div>";
    function f() {
        var g = T.G(c);
...
CodeStat = (function() {
    ...
    function i(k) {
        ...
        setTimeout(function() {
            if (!a) {
                T.ajax.request(MapConfig.smFlwCon + "img/transparent.gif?newmap=1" + k.src, f)
            } else {
                d.src = MapConfig.smFlwCon + "img/transparent.gif?newmap=1" + k.src
            }
        },
        100)
    }
...
var mapPass = {
    ...
    setDialog: function() {
        ...
        c.push('<div class="nopass">还没有百度帐号？<a href="https://passport.baidu.com/v2/?reg&regType=1&tpl=ma" target="_blank">立即注册</a></div>');
        var b = {
...
var Special = {
    ...
    getHtml: function(p) {
        ...
        for (var w in Special.data) {
            ...
            if (w == "weather" || w == "lunch" || t[u] || (w == "tuan" && Special.data.tuan.sup)) {
                v += "<li" + y + '><a href="' + j + '" ' + g + m + '><img src="' + MapConfig.smFlwCon + 'image/transparent.gif" class="' + w + '" /><b>' + q + "</b>" + l + "</a></li>";
                b++
            }
        }
    ...
    _getTuanHtml: function(b) {
        ...
        return '<div class="boxContent tuan-guid"><ul class="toolsIcon"><li onmouseover="T.ac(this,\'hover\')" onmouseout="T.rc(this,\'hover\')" ><a href="javascript:void(0)" onclick="addStat(STAT_TUAN_GUIDE_CLICK);window.open(\'' + a + '\')"><img src="image/transparent.gif" class="tuan" /><b>团购</b><p>' + c + "</p></a></li></ul></div>"
    },
...
T.extend(City.prototype, {
    ...
    countryHtml: function() {
        ...
        c.push('<div id="user_feedback" class="blueC">百度提醒您：结果有错误？请到<a id="mapComplaintCenter" href="http://tousu.baidu.com/map/add?place=#keyword#" onclick="addStat(STAT_TOUSU_LIST_NOR)" target="_blank">百度地图投诉中心</a>反馈。</div>');
        c.push("</div>");
        return c.join("")
    },
    setArea: function() {
    ...
    setPctoMoin: function(a) {
        var b = ['<div class="pctomoin">', '<a onclick="PcToMobile.open(\'CITY\')" href="javascript:void(0)">', '<img width="273" height="59" src="image/pctomoicon.png?v=120808" alt="手机地图下载" />', "</a>", "</div>"];
...
function getBaikeCardCallback(d) {
    if (d && d.key && d["abstract"]) {
        ...
        c.push('<div style="text-align:right;">来自 <a href="' + d.url + '" target="_blank">百度百科</a><div>');
...
var A_J_MARKER_IMG = MapConfig.smFlwCon + "image/markers_new.png";
...
var A_J_MARKER_NEWYEAR_IMG = MapConfig.smFlwCon + "image/newyear2012/markers_new.png";
...
bdMapSuggest.prototype = {
    ...
    sendQuery: function(qString) {
        ...
        if (cityId == 1 && this.I.id.indexOf("BusSearch") > -1) {
            pars = "u.php?wd=" + encodeURIComponent(!qString ? this.I.value: qString) + "&cid=" + cityId + "&type=0&newmap=1&b=" + bounds + "&t=" + new Date().getTime()
        } else {
            pars = "u.php?wd=" + encodeURIComponent(!qString ? this.I.value: qString) + "&cid=" + cityId + "&type=" + this.qType + "&newmap=1&b=" + bounds + "&t=" + new Date().getTime()
        }
    ...
    var l = {
        ...
        getLoginHtml: function(w) {
            ...
            u.push('<li class="line">|</li>');
            u.push('<li><a href="http://www.baidu.com">百度首页</a></li>');
            return u.join("")
        },
        tip: {
            add: function() {
        ...
        tip: {
            add: function() {
                if (T.cookie.get("Maptodowntip") !== "2") {
                    beforeEndHTML(document.body, '<div id="MaptoDown_tip" class="search-tip"><i onclick="PcToMobile.tip.remove()" title="关闭" class="close">关闭</i><div class="inner"><div class="lk-btn1"><a href="http://bbs.xcheying.com">车影论坛</a></div><div class="lk-btn"><a href="http://bbs.xcheying.com">欢迎使用车影论坛地图</a></div></div></div>')
                }
            },
            remove: function() {
    ...
    var a = {
        ...
        getBaikeCardCallback: function(d) {
            if (d && d.key && d["abstract"]) {
                ...
                c.push('<dd class="baike-des">来自 <a href="' + d.url + '" target="_blank">百度百科</a><dd>');
                c.push("</dl>");
