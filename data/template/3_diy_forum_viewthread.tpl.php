...
0
|| checktplrefresh('./template/eis_y_car/forum/viewthread.htm', './template/eis_y_car/common/header.htm', 1364401222, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/eis_y_car', 'forum/viewthread')
|| checktplrefresh('./template/eis_y_car/forum/viewthread.htm', './template/eis_y_car/forum/viewthread_node.htm', 1364401222, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/eis_y_car', 'forum/viewthread')
|| checktplrefresh('./template/eis_y_car/forum/viewthread.htm', './template/eis_y_car/forum/viewthread_fastpost.htm', 1364401222, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/eis_y_car', 'forum/viewthread')
|| checktplrefresh('./template/eis_y_car/forum/viewthread.htm', './template/eis_y_car/common/footer.htm', 1364401222, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/eis_y_car', 'forum/viewthread')
|| checktplrefresh('./template/eis_y_car/forum/viewthread.htm', './template/eis_y_car/common/header_common.htm', 1364401222, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/eis_y_car', 'forum/viewthread')
|| checktplrefresh('./template/eis_y_car/forum/viewthread.htm', './template/eis_y_car/common/pubsearchform.htm', 1364401222, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/eis_y_car', 'forum/viewthread')
|| checktplrefresh('./template/eis_y_car/forum/viewthread.htm', './template/eis_y_car/forum/viewthread_node_body.htm', 1364401222, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/eis_y_car', 'forum/viewthread')
|| checktplrefresh('./template/eis_y_car/forum/viewthread.htm', './template/default/common/seditor.htm', 1364401222, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/eis_y_car', 'forum/viewthread')
|| checktplrefresh('./template/eis_y_car/forum/viewthread.htm', './template/default/common/seccheck.htm', 1364401222, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/eis_y_car', 'forum/viewthread')
;?>
...
<?php if(empty($_GET['diy'])) { ?><?php $_GET['diy'] = '';?><?php } if(!isset($topic)) { ?><?php $topic = array();?><?php } ?>
    ...
    <style type="text/css">
        ...
        .eis_ttp{ border-top:1px solid #9DB3C5 !important; height:30px; line-height:30px; padding-top:1px !important; margin-bottom:0 !important; background:url(<?php echo IMGDIR;?>/tabbg.jpg) repeat-x 0 1px;text-align:center;}
        .ttp a, .ttp strong{ padding:0 0 0 12px !important; background:none !important; border:none !important; color:#fff !important}
        .ttp .a a{ border:none !important; background:#fff !important; color:#000 !important;width:60px;height:23px;margin:1px;}
        .ttp a:hover{ text-decoration:underline}
        .eis_ttp li{ _padding-bottom:0px;}
        .eis_ttp .pipe{ _margin-top:-3px;}
        .tl .tf{}
        .tl .th td, .tl .th th{ padding:4px 0 !important; padding:4px 0 5px\9!important;}
        ...
        .num,.by{text-align:center;padding-left:-2px;}
        ...
        <?php if(!IS_ROBOT) { ?>
            ...
            <?php } ?>
                ...
                <div id="eis_us_menu" class="p_pop" style="display:none">
                    <?php if($_G['uid']) { ?>
                    <ul>
                        <li><a href="home.php?mod=spacecp">设置000</a></li>
                        <li><a href="home.php?mod=space&amp;do=pm" id="pm_ntc"<?php if($_G['member']['newpm']) { ?> class="new"<?php } ?>>消息111</a></li>
                        <li><a href="home.php?mod=space&amp;do=notice" id="myprompt"<?php if($_G['member']['newprompt']) { ?> class="new"<?php } ?>>提醒222<?php if($_G['member']['newprompt']) { ?>(<?php echo $_G['member']['newprompt'];?>)<?php } ?></a><span id="myprompt_check"></span></li>
                        ...
                        <?php if($_G['uid'] && $_G['group']['radminid'] > 1) { ?>
                            <li><a href="forum.php?mod=modcp&amp;fid=<?php echo $_G['fid'];?>" target="_blank"><?php echo $_G['setting']['navs']['2']['navname'];?>管理333</a></li>
                        <?php } ?>
                        <?php if($_G['uid'] && $_G['adminid'] == 1 && $_G['setting']['cloud_status']) { ?>
                            <li><a href="admin.php?frames=yes&amp;action=cloud&amp;operation=applist" target="_blank">云平台444</a></li>
                        <?php } ?>
                        <li><a href="home.php?mod=spacecp&amp;ac=usergroup"<?php if($upgradecredit !== 'false') { ?> id="g_upmine" class="xi2" onMouseOver="delayShow(this, showUpgradeinfo)"<?php } ?>><?php echo $_G['group']['grouptitle'];?>666</a></li>
                        <?php if($_G['uid'] && getstatus($_G['member']['allowadmincp'], 1)) { ?>
                            <li><a href="admin.php" target="_blank">管理中心555</a></li>
                        <?php } ?>
...
<div id="ct" class="wp cl">
    <div id="pgt" class="pgs mbm cl <?php if($modmenu['thread']) { ?>pbm bbs<?php } ?>">
        <div class="pgt" style="float:left;">
        <?php if(!$multipage) { ?>
        <div class="pg"><strong>1</strong>到<input type="text" name="custompage" class="px" size="2" title="输入页码，按回车快速跳转" value="1" onkeydown="if(event.keyCode==13) {window.location='forum.php?mod=viewthread&tid=352&amp;extra=&amp;page='+this.value; doane(event);}" />页<button type="submit" value="跳转">跳转</button><input type="text" class="px" size="2" onkeyup="$('fj_btn').href='forum.php?mod=redirect&ptid=<?php echo $_G['tid'];?>&authorid=<?php echo $_GET['authorid'];?>&postno='+this.value" onkeydown="if(event.keyCode==13) {window.location=$('fj_btn').href;return false;}"/>楼<a href="javascript:;" id="fj_btn" title="跳转到指定楼层" style="float:none;"><img src="<?php echo IMGDIR;?>/fj_btn.png" alt="到指定楼层" class="vm" /></a></div>
        <?php } else { ?>
        <?php echo $multipage;?><div class="pg"><input type="text" class="px" size="2" onkeyup="$('fj_btn').href='forum.php?mod=redirect&ptid=<?php echo $_G['tid'];?>&authorid=<?php echo $_GET['authorid'];?>&postno='+this.value" onkeydown="if(event.keyCode==13) {window.location=$('fj_btn').href;return false;}"/>楼<a href="javascript:;" id="fj_btn" title="跳转到指定楼层" style="float:none;"><img src="<?php echo IMGDIR;?>/fj_btn.png" alt="到指定楼层" class="vm" /></a></div>
        <?php } ?>
        </div>
...
<?php } if($modmenu['thread']) { ?>
    <div id="modmenu" class="xi2 pbm">
        <?php $modopt=0;?>        <?php if($_G['forum']['ismoderator']) { ?>
            ...
            <?php if($_G['group']['allowbumpthread'] && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(3, 'down')">升降</a><span class="pipe">|</span><?php } ?>
            ...
            <?php if($_G['group']['allowhighlightthread'] && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(1, 'highlight')">高亮</a><span class="pipe">|</span><?php } ?>
            <?php if($_G['group']['allowdigestthread'] && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(1, 'digest')">精华</a><span class="pipe">|</span><?php } ?>
            <?php if($_G['group']['allowrecommendthread'] && !empty($_G['forum']['modrecommend']['open']) && $_G['forum']['modrecommend']['sort'] != 1 && !$_G['forum_thread']['is_archived']) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(1, 'recommend')">推荐</a><span class="pipe">|</span><?php } ?>
            ...
            <?php if($_G['group']['allowclosethread'] && !$_G['forum_thread']['is_archived'] && $_G['forum']['status'] != 3) { ?><?php $modopt++?><a href="javascript:;" onclick="modthreads(4)"><?php if(!$_G['forum_thread']['closed']) { ?>关闭<?php } else { ?>打开<?php } ?></a><span class="pipe">|</span><?php } ?>
        ...
        <?php if($post['authorid'] && $post['username'] && !$post['anonymous']) { ?>
            ...
            <?php if($_G['setting']['authoronleft']) { ?>
                <div  style="text-align:center">
                    <div class="authi"><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xw1" style="color:#06F;font-size:16px"><?php echo $post['author'];?></a><?php echo $authorverifys;?></div>
                </div>
            <?php } ?>
            ...
            <?php } ?>
            <span style="padding-left:10px"><em><a href="home.php?mod=spacecp&amp;ac=usergroup&amp;gid=<?php echo $post['groupid'];?>" target="_blank"><?php echo $post['authortitle'];?></a></em></span>
            ...
            <?php if($post['authorid'] != $_G['uid']) { ?>
                <ul><li  style="width:130px; padding-left:20px;"><em>来&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;自：</em></li></ul>
                <ul><li  style="width:130px; padding-left:20px;"><em>注册时间：</em><?php echo $post['regdate'];?></li></ul>
                
                <ul class="xl xl2 o cl">
                
                    <li style="width:110px;background-image:url(../../../static/image/common/pmto.gif);">
<a id="a_sendpm_<?php echo $post['authorid'];?>" title="发送消息" onclick="showWindow('showMsgBox', this.href, 'get', 0)" href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_8&amp;touid=<?php echo $post['authorid'];?>&amp;pmid=0&amp;daterange=2" class="xi2">发送消息</a></li>

                    <li style="width:110px;background-image:url(../../../static/image/feed/friend.gif);">
<a href="home.php?mod=spacecp&amp;ac=friend&amp;op=add&amp;uid=<?php echo $post['authorid'];?>&amp;handlekey=addfriendhk_<?php echo $post['authorid'];?>" id="a_friend_li_<?php echo $post['authorid'];?>" onclick="showWindow(this.id, this.href, 'get', 0);" class="xi2">加为好友</a></li>
                    

                </ul>
                <ul><li  style="width:130px; padding-left:20px;"><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>&amp;do=profile" style="color:#06F">查看TA的个人资料</a></li></ul>
            <?php } ?>
