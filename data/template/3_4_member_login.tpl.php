...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1364655241, '4', './data/template/3_4_member_login.tpl.php', './template/eis_y_car', 'member/login')
