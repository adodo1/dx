...
0
|| checktplrefresh('./template/default/forum/post.htm', './template/eis_y_car/common/header.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_extra.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_body.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_attribute.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/seccheck.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_option.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/editor_menu.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/editor_menu_forum.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/eis_y_car/common/footer.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/header_common.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/eis_y_car/common/pubsearchform.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/editor.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1364656187, '4', './data/template/3_4_forum_post.tpl.php', './template/eis_y_car', 'forum/post')
;?>
...
<ul class="tb cl mbw">
<?php if($savecount) { ?>
<li class="y"><a id="draftlist" href="javascript:;" class="xi2" onmouseover="showMenu({'ctrlid':'draftlist','ctrlclass':'a','duration':2,'pos':'34'})" style="padding:0 30px;">草稿箱(<strong><?php echo $savecount;?></strong>)</a></li>
<?php } if(!$_G['forum']['threadsorts']['required'] && !$_G['forum']['allowspecialonly']) { ?><li<?php echo $postspecialcheck['0'];?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread')" style="padding:0 30px;">发表帖子</a></li><?php } if(is_array($_G['forum']['threadsorts']['types'])) foreach($_G['forum']['threadsorts']['types'] as $tsortid => $name) { ?><li<?php if($sortid == $tsortid) { ?> class="a"<?php } ?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&sortid=<?php echo $tsortid;?>')" style="padding:0 30px;"><?php echo strip_tags($name);; ?></a></li>
<?php } if($_G['group']['allowpostpoll']) { ?><li<?php echo $postspecialcheck['1'];?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&special=1')" style="padding:0 30px;">发起投票</a></li><?php } if($_G['group']['allowpostreward']) { ?><li<?php echo $postspecialcheck['3'];?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&special=3')" style="padding:0 30px;">发布悬赏</a></li><?php } if($_G['group']['allowpostdebate']) { ?><li<?php echo $postspecialcheck['5'];?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&special=5')" style="padding:0 30px;">发起辩论</a></li><?php } if($_G['group']['allowpostactivity']) { ?><li<?php echo $postspecialcheck['4'];?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&special=4')" style="padding:0 30px;">发起活动</a></li><?php } if($_G['group']['allowposttrade']) { ?><li<?php echo $postspecialcheck['2'];?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&special=2')">出售商品</a></li><?php } if($_G['setting']['threadplugins']) { if(is_array($_G['forum']['threadplugin'])) foreach($_G['forum']['threadplugin'] as $tpid) { if(array_key_exists($tpid, $_G['setting']['threadplugins']) && @in_array($tpid, $_G['group']['allowthreadplugin'])) { ?>
<li<?php if($specialextra==$tpid) { ?> class="a"<?php } ?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&specialextra=<?php echo $tpid;?>')" style="padding:0 30px;"><?php echo $_G['setting']['threadplugins'][$tpid]['name'];?></a></li>
<?php } } } ?>
</ul>
