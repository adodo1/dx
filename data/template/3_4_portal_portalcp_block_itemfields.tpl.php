...
<td>
<?php if($field['formtype']=='title') { ?><?php $_titlelength = !empty($block['param']['titlelength']) ? $block['param']['titlelength'] : 40;?><input type="text" name="title" class="px" value="<?php echo $itemfields['title'];?>" onkeyup="strLenCalc(this, 'titlechk', <?php echo $_titlelength;?>);" _maxlength="<?php echo $_titlelength;?>" />
...
<?php } elseif($field['formtype']=='summary') { ?><?php $_summarylength = !empty($block['param']['summarylength']) ? $block['param']['summarylength'] : 80;?><textarea name="summary" class="pt" onkeyup="strLenCalc(this, 'summarychk', <?php echo $_summarylength;?>);" _maxlength="<?php echo $_summarylength;?>" ><?php echo $itemfields['summary'];?></textarea>
