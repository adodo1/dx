...
$admincp_actions_normal = array('index', 'setting', 'members', 'admingroup', 'usergroups', 'usertag',
	'forums', 'threadtypes', 'threads','moderator', 'moderate', 'attach', 'smilies', 'recyclebin', 'recyclebinpost', 'prune',
	...
	'district', 'diytemplate', 'verify', 'nav', 'domain', 'postcomment', 'tag', 'connect', 'card', 'portalpermission', 'collection', 'membersplit','applyjoin');
