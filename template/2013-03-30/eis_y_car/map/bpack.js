...
function openTaxi(i, a, h) {
    ...
    var a = {
        ...
        open: function(d, e) {
            ...
            b.innerHTML = "<img id='inr_logo' src='./template/eis_y_car/map/image/transparent.gif' width=137 height=35 /><span id='inr_loader' title='正在加载中...'></span><span id='inr_close' title='关闭' onclick='InrMgr.close()'></span>";
            b.appendChild(h);
            this.container = b;
            this.framer = h;
            this.cover = f;
...
function addTransPoi(h, g, i, a) {
    ...
    var e = new BMap.Icon(MapConfig.smFlwCon + "./template/eis_y_car/map/image/trans_icons.png", new BMap.Size(21, 21), {
...
function addDestPoi(g, i, e, f, b) {
    ...
    if (!f) {
        var d = new BMap.Icon(MapConfig.smFlwCon + "./template/eis_y_car/map/image/dest_markers.png", DEST_MARKER_SIZE, {
...
function addDrvDirIcon(b, d, c) {
    ...
    var a = d * ( - 18);
    var f = new BMap.Icon(MapConfig.smFlwCon + "./template/eis_y_car/map/image/dest_markers.png", new BMap.Size(18, 18), {
...
function createSearchInfoWnd(Z, aK) {
    ...
    if (aK && aK.isFromMPC) {
        aE.push("<ul class='nav_tab'><li id='nav_tab2' class='third blueA " + a[0] + "' onclick='switchInfoWndTab(2, \"rangekw\", null, null, 1)'><img src='" + MapConfig.smFlwCon + "./template/eis_y_car/map/./template/eis_y_car/map/image/transparent.gif'>在附近找</li>");
        aE.push("<li id='nav_tab0' class='second blueA " + a[1] + "' onclick='switchInfoWndTab(0, \"iw_ssn\", null, null, 1)'><img src='" + MapConfig.smFlwCon + "./template/eis_y_car/map/./template/eis_y_car/map/image/transparent.gif'>到这里去</li>");
        aE.push("<li id='nav_tab1' class='first blueA " + a[2] + "' onclick='switchInfoWndTab(1, \"iw_esn\", null, null, 1)'><img src='" + MapConfig.smFlwCon + "./template/eis_y_car/map/./template/eis_y_car/map/image/transparent.gif'>从这里出发</li></ul>")
    } else {
        aE.push("<ul class='nav_tab'><li id='nav_tab2' class='third blueA " + a[0] + "' onclick='switchInfoWndTab(2, \"rangekw\")'><img src='" + MapConfig.smFlwCon + "./template/eis_y_car/map/image/transparent.gif'>在附近找</li>");
        aE.push("<li id='nav_tab0' class='second blueA " + a[1] + "' onclick='switchInfoWndTab(0, \"iw_ssn\")'><img src='" + MapConfig.smFlwCon + "./template/eis_y_car/map/image/transparent.gif'>到这里去</li>");
        aE.push("<li id='nav_tab1' class='first blueA " + a[2] + "' onclick='switchInfoWndTab(1, \"iw_esn\")'><img src='" + MapConfig.smFlwCon + "./template/eis_y_car/map/image/transparent.gif'>从这里出发</li></ul>")
    }
...
function createTip(f, d, e) {
    ...
    var a = new BMap.Marker(e.point, {
        icon: new BMap.Icon(MapConfig.smFlwCon + "./template/eis_y_car/map/image/transparent.gif", new BMap.Size(1, 1))
    });
    b.setStyle(e.style);
    a.setLabel(b);
    if (e.display == false) {
...
function initDriveControlHelper(t, f, M, ak) {
    ...
    var Y = MapConfig.smFlwCon + "./template/eis_y_car/map/image/route_markers.png",
    j = 23,
    h = {},
