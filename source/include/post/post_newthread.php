...
if(!submitcheck('topicsubmit', 0, $seccodecheck, $secqaacheck)) {
	...
	$objhidden0 = $_POST['objhidden0'];
	$objhidden1 = $_POST['objhidden1'];
	$maponlook0 = $_POST['maponlook0'];
	$maponlook1 = $_POST['maponlook1'];
	$mapony0 = $_POST['mapony01'];
	$mapony1 = $_POST['mapony1'];
	...
	$newthread = array(
		...
		'objhidden0' => $objhidden0,
		'objhidden1' => $objhidden1,
		'maponlook0' => $maponlook0,
		'maponlook1' => $maponlook1,
		'mapony0' => $mapony0,
		'mapony1' => $mapony1
